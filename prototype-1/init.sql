...
CREATE TABLE Groups (
   ...
   size INT NOT NULL,
   bmcUsername varchar(255) NULL,
   bmcPassword varchar(255) NULL,
   bmcIpMask varchar(255) NULL
);
-- ===========================================================
-- Asset Types
-- ===========================================================
...
-- Server
-- ===========================================================
INSERT INTO AssetTypeFields (assetTypeId, name, type, fixed)
VALUES (1, 'IPAddress', 'string', FALSE),
   (1, 'UUID', 'string', TRUE),
