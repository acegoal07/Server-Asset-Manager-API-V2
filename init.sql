...
CREATE TABLE
   Storages (
      ...
      notes TEXT NULL,
      storageTypeId INT,
      CONSTRAINT fk_storages_storageType FOREIGN KEY (storageTypeId) REFERENCES StorageTypes (id) ON DELETE SET NULL
   );
...
VALUES
   ...
   (1, 'RAM GB', 'number', FALSE),
   (1, 'Operating System', 'string', FALSE),
   (1, 'Virtualized', 'boolean', FALSE),
   (1, 'Installation Date', 'date', FALSE);

-- ===========================================================
-- Storage Array
-- ===========================================================
INSERT INTO
   AssetTypeFields (assetTypeId, name, type)
VALUES
   (3, 'UUID', 'string'),
   (3, 'IP Address', 'string'),
   (3, 'Model', 'string'),
...
INSERT INTO
   StorageTypes (id, name)
VALUES
   (1, 'Rack');

INSERT INTO
   StorageTypeFields (storageTypeId, name, type)
VALUES
   (1, 'U Size', 'number');